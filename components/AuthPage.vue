...
" alt="authentication image" class="absolute inset-0 object-cover w-full h-full" />
    </div>
    <div class="flex flex-col justify-center flex-1 px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px24">
